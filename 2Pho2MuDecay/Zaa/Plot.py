...
for x in ["Pt"]:
    ...
    scaleZZZ = (h_ZZZ.GetEntries()/400000) * 100000 * .0051394;
    scaleXX500 = (h_XX500.GetEntries()/25000) * 100000 * .0000061352 * results[x + "500"];
    scaleXX1000 = (h_XX1000.GetEntries()/10000) * 100000 * .000006909 * results[x + "1000"];
    scaleXX1500 = (h_XX1500.GetEntries()/10000) * 100000 * .0000051622 * results[x + "1500"];
    scaleXX2000 = (h_XX2000.GetEntries()/10000) * 100000 * .0000032929 * results[x + "2000"];
    ...
    c.SaveAs("/mnt/c/Users/perse/Documents/PhysicsHistos/2Muon2PhoZaaMass" + x + ".png");
