...
if __name__ == '__main__':
    ...
    directory_bkg = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/1Pho2Mu1JetBackground/Events/run_01/tag_1_delphes_events.root']
    ...
    output_bkg = [reconstruct(p, extra_ps={'photon': 1}, z_products = {'muon': 2, 'fatjet': 1}, count_histos=count_histos_bkg) for p in directory_bkg]
    ...
    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/500/1Pho2Mu1JetZZ500/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, extra_ps={'photon': 1}, z_products={'muon': 2, 'fatjet': 1}, count_histos=count_histos_sig) for d in directory]
