...
for x in ["Pt"]:
    ...
    h_ZZZ.SetTitle("4 Muon 1 Photon Decay Reconstruction " + x);
    ...
    scaleZZZ = (h_ZZZ.GetEntries()/100000) * 100000 * .000051302;
    scaleXX500 = (h_XX500.GetEntries()/10000) * 100000 * .00000010338 * results[x + "500"];
    scaleXX1000 = (h_XX1000.GetEntries()/10000) * 100000 * .00000014734 * results[x + "1000"];
    scaleXX1500 = (h_XX1500.GetEntries()/10000) * 100000 * .00000011876 * results[x + "1500"];
    scaleXX2000 = (h_XX2000.GetEntries()/10000) * 100000 * .000000078415 * results[x + "2000"];
    ...
    c.SaveAs("/mnt/c/Users/perse/Documents/PhysicsHistos/1Pho2Mu1JetZZMass" + x + ".png");
