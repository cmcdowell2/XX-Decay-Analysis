...
scaleXX500Pt = (h_XX500Pt.GetEntries()/25000) * 100000 * .0000039873;
...
#scaleZZZPhi = (h_ZZZPhi.GetEntries()/200000) * 100000 * 29.85;
scaleZZZPt = (h_ZZZPt.GetEntries()/300000) * 100000 * 28.75;
#scaleZZZEta = (h_ZZZEta.GetEntries()/200000) * 100000 * 29.85;
