...
if __name__ == '__main__':
    ...
    directory_bkg = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/2Mu2JetBackground/Events/FinalOutput.root']
    ...
    output_bkg = [reconstruct(p, z_products = {'muon': 2, 'fatjet' : 2}, count_histos=count_histos_bkg) for p in directory_bkg]
    ...
    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/2Mu2Jet500/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, z_products={'muon': 2, 'fatjet' : 2}, count_histos=count_histos_sig) for d in directory]
