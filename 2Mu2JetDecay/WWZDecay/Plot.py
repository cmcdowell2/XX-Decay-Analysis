...
for x in ["Pt"]:
    ...
    scaleZZZ = (h_ZZZ.GetEntries()/100000) * 100000 * 29.675;
    scaleXX500 = (h_XX500.GetEntries()/10000) * 100000 * .0000041172 * results[x + "500"];
    scaleXX1000 = (h_XX1000.GetEntries()/10000) * 100000 * .0000052396 * results[x + "1000"];
    scaleXX1500 = (h_XX1500.GetEntries()/10000) * 100000 * .0000040391 * results[x + "1500"];
    scaleXX2000 = (h_XX2000.GetEntries()/10000) * 100000 * .0000025785 * results[x + "2000"];
    ...
    c.SaveAs("/mnt/c/Users/perse/Documents/PhysicsHistos/2Muon2JetWWXXMass" + x + ".png");
