...
if __name__ == '__main__':
    ...
    directory_bkg = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/Background/2Mu2JetBackground/Events/run_01/tag_1_delphes_events.root']
    ...
    output_bkg = [reconstruct(p, z_products = {'muon': 2}, w_products = {'fatjet': 2}, count_histos=count_histos_bkg) for p in directory_bkg]
    ...
    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/2000/2Mu2JetW2000/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, z_products={'muon': 2}, w_products={'fatjet': 2}, count_histos=count_histos_sig) for d in directory]
