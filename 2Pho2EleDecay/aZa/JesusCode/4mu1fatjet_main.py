...
if __name__ == '__main__':
    ...
    directory_bkg = ['/home/achilles12/Physics/Background/2Pho2EleBackground/Events/run_01/tag_1_delphes_events.root']
    ...
    output_bkg = [reconstruct(p, z_products={'muon': 2}, xx_products = {'photon': 1},
    ...
    ###----------------Signal----------------###
    directory = ['/home/achilles12/Physics/500/2Pho2EleA500/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, z_products={'muon': 2}, xx_products={'photon': 1}, count_histos=count_histos_sig) for d in directory]
