...
for x in ["Phi", "Pt"]:
    ...
    h_ZZZ.GetYaxis().SetLimits(0, 100000);
    ...
    scaleZZZ = (h_ZZZ.GetEntries()/100000) * 100000 * 29.666;
    #scaleXX500 = (h_XX500.GetEntries()/10000) * 100000 * .0000039979 * results[x + "500"];
    #scaleXX1000 = (h_XX1000.GetEntries()/10000) * 100000 * .0000052399 * results[x + "1000"];
    #scaleXX1500 = (h_XX1500.GetEntries()/10000) * 100000 * .000004031 * results[x + "1500"];
    #scaleXX2000 = (h_XX2000.GetEntries()/10000) * 100000 * .0000025888 * results[x + "2000"];
    ...
    c.SaveAs("/mnt/c/Users/perse/Documents/PhysicsHistos/2Ele1JetXXMass" + x + ".png");
