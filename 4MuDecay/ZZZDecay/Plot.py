...
for x in ["Phi", "Pt"]:
    ...
    h_ZZZ.SetTitle("4 Muon Decay Reconstruction " + x);
    ...
    scaleZZZ = (h_ZZZ.GetEntries()/100000) * 100000 * .003333;
    #scaleXX500 = (h_XX500.GetEntries()/10000) * 100000 * .0000002546;
    #scaleXX1000 = (h_XX1000.GetEntries()/10000) * 100000 * .0000003352 * results[x + "1000"];
    #scaleXX1500 = (h_XX1500.GetEntries()/10000) * 100000 * .0000002594 * results[x + "1500"];
    #scaleXX2000 = (h_XX2000.GetEntries()/10000) * 100000 * .0000001665 * results[x + "2000"];
    ...
    c.SaveAs("/mnt/c/Users/perse/Documents/PhysicsHistos/4MuonXXMass" + x + ".png");
