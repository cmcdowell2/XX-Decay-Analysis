...
if __name__ == '__main__':
    ...
    directory_bkg = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/Background/4MuBackground/Events/run_01/tag_1_delphes_events.root']
    ...
    output_bkg = [reconstruct(p, z_products = {'muon': 4, 'fatjet' : 1}, count_histos=count_histos_bkg) for p in directory_bkg]
    ...
    for bi in range(0, 52):
        print(bkg_histo.GetBinContent(bi))
        bin_content_file.write(str(bkg_histo.GetBinContent(bi)) + '\n')
    bin_content_file.close()

    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/500/4Mu500/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, z_products={'muon': 4, 'fatjet' : 1}, count_histos=count_histos_sig) for d in directory]
