...
scaleXX500Phi = (h_XX500Phi.GetEntries()/10000) * 100000 * .00000025462;
...
scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .00000025462;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .0000003352;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .0000002594;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .0000001665;

scaleXX500Eta = (h_XX500Eta.GetEntries()/10000) * 100000 * .00000025462;
...
scaleZZZPt = (h_ZZZPt.GetEntries()/100000) * 100000 * .003333;
