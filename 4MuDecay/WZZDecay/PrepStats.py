...
#scaleXX500Phi = (h_XX500Phi.GetEntries()/25000) * 100000 * .0000002546;
#scaleXX1000Phi = (h_XX1000Phi.GetEntries()/10000) * 100000 * .0000003352;
#scaleXX1500Phi = (h_XX1500Phi.GetEntries()/10000) * 100000 * .0000002594;
#scaleXX2000Phi = (h_XX2000Phi.GetEntries()/10000) * 100000 * .0000001665;

scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .00000017878;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .00000025779;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .00000020846;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .00000013757;

#scaleXX500Eta = (h_XX500Eta.GetEntries()/25000) * 100000 * .0000002546;
#scaleXX1000Eta = (h_XX1000Eta.GetEntries()/10000) * 100000 * .0000003352;
#scaleXX1500Eta = (h_XX1500Eta.GetEntries()/10000) * 100000 * .0000002594;
#scaleXX2000Eta = (h_XX2000Eta.GetEntries()/10000) * 100000 * .0000001665;

#scaleZZZPhi = (h_ZZZPhi.GetEntries()/100000) * 100000 * .003333;
scaleZZZPt = (h_ZZZPt.GetEntries()/100000) * 100000 * .0033248;
#scaleZZZEta = (h_ZZZEta.GetEntries()/100000) * 100000 * .003333;
...
for mass in [500, 1000, 1500, 2000]:
    ...
    for ibin in range(0, h_ZZZPhi.GetNbinsX() + 1):
