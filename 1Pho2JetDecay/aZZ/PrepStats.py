...
scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .000025095;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .000035833;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .000028878;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .000019104;

scaleZZZPt = (h_ZZZPt.GetEntries()/100000) * 400000 * 87466;
...
for mass in [500, 1000, 1500, 2000]:
    ...
    for ibin in range(0, h_ZZZPt.GetNbinsX() + 1):
