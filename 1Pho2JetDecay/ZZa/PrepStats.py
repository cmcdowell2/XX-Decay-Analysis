...
scaleXX500Phi = (h_XX500Phi.GetEntries()/10000) * 100000 * .000033168;
scaleXX1000Phi = (h_XX1000Phi.GetEntries()/10000) * 100000 * .000042564;
scaleXX1500Phi = (h_XX1500Phi.GetEntries()/10000) * 100000 * .000032697;
scaleXX2000Phi = (h_XX2000Phi.GetEntries()/10000) * 100000 * .000021059;

scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .000033168;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .000042564;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .000032697;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .000021059;

scaleXX500Eta = (h_XX500Eta.GetEntries()/10000) * 100000 * .000033168;
scaleXX1000Eta = (h_XX1000Eta.GetEntries()/10000) * 100000 * .000042564;
scaleXX1500Eta = (h_XX1500Eta.GetEntries()/10000) * 100000 * .000032697;
scaleXX2000Eta = (h_XX2000Eta.GetEntries()/10000) * 100000 * .000021059;

scaleZZZPhi = (h_ZZZPhi.GetEntries()/100000) * 100000 * 11558;
scaleZZZPt = (h_ZZZPt.GetEntries()/100000) * 100000 * 11558;
scaleZZZEta = (h_ZZZEta.GetEntries()/100000) * 100000 * 11558;
