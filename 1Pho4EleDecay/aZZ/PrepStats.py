...
scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .00000010338;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .00000014734;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .00000011876;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .000000078416;
