...
if __name__ == '__main__':
    ...
    directory_bkg = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/1Pho4EleBackground/Events/run_01/tag_1_delphes_events.root']
    ...
    output_bkg = [reconstruct(p, xx_products={'photon': 1}, z_products = {'electron': 4},
    ...
    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/2000/1Pho4EleZa2000/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   

    # dictionaries with histograms to count particles
    count_histos_sig = {'electron': ROOT.TH1F('Signal Muon Count', ' ; amount; events', 6, 0, 6),
                        'photon': ROOT.TH1F('Signal Photon Count', ' ; amount; events', 6, 0, 6)}

    # list of outputs from reconstruct() function for each file
    output = [reconstruct(d, xx_products={'photon': 1}, z_products={'electron': 4}, count_histos=count_histos_sig) for d in directory]

    # Masses and xs lists correpsonding to each file
    xs_list = [.000000050508]
    mass_list = [2000]
