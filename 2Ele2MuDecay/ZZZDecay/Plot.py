...
for x in ["Pt"]:
    ...
    h_ZZZ.SetTitle("2 Ele 2 Mu Decay Reconstruction " + x);
    ...
    scaleZZZ = (h_ZZZ.GetEntries()/10000) * 100000 * .0065782;
    #scaleXX500 = (h_XX500.GetEntries()/10000) * 100000 * .00000051158 * results[x + "500"];
    #scaleXX1000 = (h_XX1000.GetEntries()/10000) * 100000 * .00000067167 * results[x + "1000"];
    #scaleXX1500 = (h_XX1500.GetEntries()/10000) * 100000 * .0000005177 * results[x + "1500"];
    #scaleXX2000 = (h_XX2000.GetEntries()/10000) * 100000 * .00000033319 * results[x + "2000"];
    ...
    c.SaveAs("/mnt/c/Users/perse/Documents/PhysicsHistos/2Ele2Mu1JetZZZXXMass" + x + ".png");
