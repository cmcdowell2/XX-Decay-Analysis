...
if __name__ == '__main__':
    ...
    directory_bkg = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/1Pho2Ele1Jet200Background/Events/run_01/tag_1_delphes_events.root']
    
    # Cross-section corresponding to each file
    xs_list = [.64666]

    # dictionaries with histograms to count particles
    count_histos_bkg = {'electron': ROOT.TH1F('Bkg Electron Count', ' ; amount; events', 6, 0, 6),
    ...
    output_bkg = [reconstruct(p, z_products={'electron': 2, 'fatjet': 1}, xx_products = {'photon': 1}, count_histos=count_histos_bkg) for p in directory_bkg]
    ...
    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/500/1Pho2Ele1JetAZ500/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, z_products={'electron': 2, 'fatjet': 1}, xx_products={'photon': 1}, count_histos=count_histos_sig) for d in directory]
