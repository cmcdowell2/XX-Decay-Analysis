...
if __name__ == "__main__":    
    ...
    signal_hists = ['PtValues1000.txt']
    
    # Background histogram as list
    back_data = []
    background_file = open('txtFiles/ZZZPtValues1000.txt', 'r')
    ...
    with open("txtFiles/ZZZPtValues500.txt") as f:
        back_data = f.read().splitlines()
    with open("txtFiles/PtValues500.txt") as f:
