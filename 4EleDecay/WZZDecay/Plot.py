...
for x in ["Pt"]:
    ...
    h_ZZZ.SetTitle("4 Electron Decay Reconstruction " + x);
    ...
    scaleZZZ = (h_ZZZ.GetEntries()/10000) * 100000 * .0032891;
    scaleXX500 = (h_XX500.GetEntries()/10000) * 100000 * .00000025436 * results[x + "500"];
    scaleXX1000 = (h_XX1000.GetEntries()/10000) * 100000 * .00000033529 * results[x + "1000"];
    scaleXX1500 = (h_XX1500.GetEntries()/10000) * 100000 * .00000025897 * results[x + "1500"];
    scaleXX2000 = (h_XX2000.GetEntries()/10000) * 100000 * .0000001661 * results[x + "2000"];
    ...
    c.SaveAs("/mnt/c/Users/perse/Documents/PhysicsHistos/4Ele1JetWZXXMass" + x + ".png");
