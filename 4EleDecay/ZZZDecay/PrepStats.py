...
scaleXX500Phi = (h_XX500Phi.GetEntries()/10000) * 100000 * .00000025436;
scaleXX1000Phi = (h_XX1000Phi.GetEntries()/10000) * 100000 * .00000033529;
scaleXX1500Phi = (h_XX1500Phi.GetEntries()/10000) * 100000 * .00000025897;
scaleXX2000Phi = (h_XX2000Phi.GetEntries()/10000) * 100000 * .0000001661;

scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .00000025436;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .00000033529;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .00000025897;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .0000001661;

scaleXX500Eta = (h_XX500Eta.GetEntries()/10000) * 100000 * .00000025436;
scaleXX1000Eta = (h_XX1000Eta.GetEntries()/10000) * 100000 * .00000033529;
scaleXX1500Eta = (h_XX1500Eta.GetEntries()/10000) * 100000 * .00000025897;
scaleXX2000Eta = (h_XX2000Eta.GetEntries()/10000) * 100000 * .0000001661;

scaleZZZPhi = (h_ZZZPhi.GetEntries()/100000) * 100000 * .0033329;
scaleZZZPt = (h_ZZZPt.GetEntries()/100000) * 100000 * 0.0033329;
scaleZZZEta = (h_ZZZEta.GetEntries()/100000) * 100000 * 0.0033329;
