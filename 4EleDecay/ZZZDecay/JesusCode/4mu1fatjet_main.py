...
if __name__ == '__main__':
    ...
    directory_bkg = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/Background/4EleBackground/Events/run_01/tag_1_delphes_events.root']
    ...
    output_bkg = [reconstruct(p, z_products = {'electron': 4, 'fatjet' : 1}, count_histos=count_histos_bkg) for p in directory_bkg]
    ...
    count_histos_bkg['electron'].Draw()
    ...
    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/500/4Ele500/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, z_products={'electron': 4, 'fatjet' : 1}, count_histos=count_histos_sig) for d in directory]
