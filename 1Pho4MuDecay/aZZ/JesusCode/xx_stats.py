...
if __name__ == "__main__":    
    ...
    signal_hists = ['../xx_stats/sig_content1.txt']
    
    # Background histogram as list
    back_data = []
    background_file = open('../xx_stats/bkg_bin_content.txt', 'r')
    ...
    with open("../xx_stats/bkg_bin_content.txt") as f:
        back_data = f.read().splitlines()
    with open("../xx_stats/sig_content1.txt") as f:
