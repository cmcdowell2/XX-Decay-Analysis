...
scaleXX500Phi = (h_XX500Phi.GetEntries()/10000) * 100000 * .00020138;
scaleXX1000Phi = (h_XX1000Phi.GetEntries()/10000) * 100000 * .00024726;
scaleXX1500Phi = (h_XX1500Phi.GetEntries()/10000) * 100000 * .00019432;
scaleXX2000Phi = (h_XX2000Phi.GetEntries()/10000) * 100000 * .00012673;

scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .00020138;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .00024726;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .00019432;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .00012673;

scaleXX500Eta = (h_XX500Eta.GetEntries()/10000) * 100000 * .00020138;
scaleXX1000Eta = (h_XX1000Eta.GetEntries()/10000) * 100000 * .00024726;
scaleXX1500Eta = (h_XX1500Eta.GetEntries()/10000) * 100000 * .00019432;
scaleXX2000Eta = (h_XX2000Eta.GetEntries()/10000) * 100000 * .00012673;

scaleZZZPhi = (h_ZZZPhi.GetEntries()/800000) * 100000 * 112.4;
scaleZZZPt = (h_ZZZPt.GetEntries()/800000) * 100000 * 112.4;
scaleZZZEta = (h_ZZZEta.GetEntries()/800000) * 100000 * 112.4;
