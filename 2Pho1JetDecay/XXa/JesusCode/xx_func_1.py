...
def reconstruct(directory, z_products={}, w_products={}, xx_products={}, extra_ps={}, count_histos=[]):
    """
        ...
        if ('fatjet' in z_products) and ('fatjet' not in w_products):
            ...
            if fatjet_amount >= z_products['fatjet']:
                ...
                while len(z_fatjet_list) > z_products['fatjet']:
                    z_bos_deltas = [pow(abs(91.1 - z.M()), 2) for z in z_fatjet_list]
    ...
    Masses = open("../JesusMasses.txt", "w")
    for x in xx_list:
        Masses.write(str(x.M()) + "\n")
