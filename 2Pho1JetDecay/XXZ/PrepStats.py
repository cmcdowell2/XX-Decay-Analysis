...
scaleXX500Phi = (h_XX500Phi.GetEntries()/10000) * 100000 * .000095598;
scaleXX1000Phi = (h_XX1000Phi.GetEntries()/10000) * 100000 * .00010803;
scaleXX1500Phi = (h_XX1500Phi.GetEntries()/10000) * 100000 * .000080966;
scaleXX2000Phi = (h_XX2000Phi.GetEntries()/10000) * 100000 * .000051339;

scaleXX500Pt = (h_XX500Pt.GetEntries()/10000) * 100000 * .000095598;
scaleXX1000Pt = (h_XX1000Pt.GetEntries()/10000) * 100000 * .00010803;
scaleXX1500Pt = (h_XX1500Pt.GetEntries()/10000) * 100000 * .000080966;
scaleXX2000Pt = (h_XX2000Pt.GetEntries()/10000) * 100000 * .000051339;

scaleXX500Eta = (h_XX500Eta.GetEntries()/10000) * 100000 * .000095598;
scaleXX1000Eta = (h_XX1000Eta.GetEntries()/10000) * 100000 * .00010803;
scaleXX1500Eta = (h_XX1500Eta.GetEntries()/10000) * 100000 * .000080966;
scaleXX2000Eta = (h_XX2000Eta.GetEntries()/10000) * 100000 * .000051339;
