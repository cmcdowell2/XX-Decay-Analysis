...
if __name__ == '__main__':
    ...
    output_bkg = [reconstruct(p, xx_products = {'photon' : 2}, z_products = {'fatjet' : 1}, count_histos=count_histos_bkg) for p in directory_bkg]
    ...
    ###----------------Signal----------------###
    directory = ['/mnt/e/Users/Cameron/AppData/Local/Packages/CanonicalGroupLimited.UbuntuonWindows_79rhkp1fndgsc/LocalState/rootfs/home/achilles12/Physics/500/2Pho1JetZ500/Events/run_01/tag_1_delphes_events.root']   # 500 GeV]   
    ...
    output = [reconstruct(d, xx_products={'photon' : 2}, z_products={'fatjet' : 1}, count_histos=count_histos_sig) for d in directory]
